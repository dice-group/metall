...
int main() {
...

  {
    ...
    dice::metall::manager manager(dice::metall::create_only, master_path.c_str());
    int *a = manager.construct<int>(dice::metall::unique_instance)(0);
  ...
  if (dice::metall::manager::consistent(snapshot_name0.c_str())) {
    dice::metall::manager manager(dice::metall::open_read_only, snapshot_name0.c_str());
    int *a = manager.find<int>(dice::metall::unique_instance).first;
  ...
  if (dice::metall::manager::consistent(snapshot_name1.c_str())) {
    dice::metall::manager manager(dice::metall::open_read_only, snapshot_name1.c_str());
    int *a = manager.find<int>(dice::metall::unique_instance).first;
  ...
  if (dice::metall::manager::consistent(master_path.c_str())) {
    dice::metall::manager manager(dice::metall::open_read_only, master_path.c_str());
    int *a = manager.find<int>(dice::metall::unique_instance).first;
